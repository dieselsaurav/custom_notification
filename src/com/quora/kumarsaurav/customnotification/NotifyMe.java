...
public class NotifyMe extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSimpleNotificationButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mNotificationBuilder = new Notification.Builder(NotifyMe.this);
        ...
        mCustomNotificationButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                RemoteViews remoteViews = new RemoteViews(getPackageName(), R.layout.notification_like);
                remoteViews.setTextViewText(R.id.tv_notification_like, "Hello, World");
                remoteViews.setTextViewCompoundDrawablesRelative(R.id.tv_notification_like, R.drawable.ic_launcher, 0, 0, 0);
                mNotificationBuilder = new Notification.Builder(NotifyMe.this);
                mNotificationBuilder.setSmallIcon(R.drawable.ic_launcher);
